...
#########################################
resource "aws_instance" "APP0011-WEB" {
...
output "instance_names" {
  value = [for i in aws_instance.APP0011-WEB : i.tags["Name"]]
}

output "instance_ids" {
  value = [for i in aws_instance.APP0011-WEB : i.id]
}

output "instance_ips" {
  value = [for i in aws_instance.APP0011-WEB : i.public_ip]
}

output "instance_dns" {
  value = [for i in aws_instance.APP0011-WEB : i.public_dns]
}
